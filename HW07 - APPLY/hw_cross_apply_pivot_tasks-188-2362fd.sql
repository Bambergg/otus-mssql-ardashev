...
SELECT InvoiceMonth, [2] as [Sylvanite, MT], [3] as [Peeples Valley, AZ], [4] as [Medicine Lodge, KS], [5] as [Gasport, NY] , [6] as [Jessie, ND]
From (
SELECT month(i.InvoiceDate) as InvoiceMonth, c.CustomerID, i.OrderID, c.CustomerName
...
Cross apply (Select top 2 CustomerID, CustomerName, StockItemID, UnitPrice, InvoiceDate
             From Sales.Invoices i
			 JOIN Sales.InvoiceLines l on i.InvoiceID = l.InvoiceID
			 Where i.CustomerID = c.CustomerID
			 Order by l.UnitPrice desc) as tbl